...
public class CommonController {
    ...
    @Autowired
    public CommonController(@Qualifier("carRepository") CarRepository carRepository,
    ...
    public ResponseEntity<Object> getVehiclesByBrand(@RequestParam("brand") String brand, @RequestParam(value = "databaseName", required = false, defaultValue = "auto") Optional<String> databaseName) {
        String dbNameForMessageAndLogger = "auto";
        if (databaseName.isPresent() && databaseName.get().equals("moto")) {
