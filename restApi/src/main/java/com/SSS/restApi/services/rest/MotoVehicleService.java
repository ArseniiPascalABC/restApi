        ...
        if ("Moto".equals(vehicle)) {
            switch (method) {
                case "getVehicleById" -> {
                    ...
                    if (moto == null) {
                        log.warn(
                                "MotoController getVehicleById, the vehicle the user was looking for(in dataBase motos) was not found");
                        return ResponseEntity
                                .ok()
                                .body("<message>Ничего не найдено по id = " + body + " в базе данных motos</message>");
                    } else {
                        log.info(
                                "MotoController getVehicleById, the vehicle the user was looking for was found in database motos");
                ...
                case "getVehiclesByBrand" -> {
                    ...
                    if (motos.isEmpty()) {
                        ...
                        return ResponseEntity
                                .ok()
                                .body("<message>Ничего не найдено по бренду " +
                                      body +
                                      " в базе данных motos</message>");
                    }
